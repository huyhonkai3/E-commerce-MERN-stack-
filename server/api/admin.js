...
router.post('/login', async function (req, res) {
    ...
    if (username && password) {
        ...
        if (admin) {
            ...
            req.session.user = {id: admin.id, username: admin.username}; // Lưu thông tin user vào session
            res.json({ success: true, message: 'Authentication successful', token: token , session: req.session.user });
        } else {
